...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background:#1977cc;" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{ Route::is('patient.dashboard*')? 'active' : '' }}">
                <a class="nav-link" href="{{ route('patient.dashboard.index') }}">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item {{ Route::is('patient.appointment*')? 'active' : '' }}">
            ...
            <li class="nav-item {{ Route::is('patient.account*')? 'active' : '' }}">
                <a class="nav-link" href="{{ route('patient.account.index') }}">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <div>
                        <a class="btn btn-primary" href="/#appointment">Make Appointment</a>
                    </div>
                    {{-- <form
