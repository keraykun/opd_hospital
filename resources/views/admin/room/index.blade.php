...
@endif
<div>
    <div><a href="{{ route('admin.room.create') }}" class="btn btn-info my-2">Create Room</a></div>
</div>
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size: 1.5rem;">Room List</h6>
    </div>
    <div class="card-body">
                ...
                <tbody>
                      @foreach ($rooms as $room)
                          <tr>
                            ...
                            <td>{{ $room->number }}</td>
                            <td><a href="{{ route('admin.room.edit',$room->id) }}" class="btn btn-sm btn-info">Edit</a></td>
                          </tr>
                      @endforeach
                </tbody>
            </table>
