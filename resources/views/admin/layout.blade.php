...
<head>
    ...
    <script src="
    https://cdn.jsdelivr.net/npm/printthis@0.1.5/printThis.min.js
    "></script>
    <!--carousel -->
</head>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background:#1977cc;" id="accordionSidebar">
            ...
            <li class="nav-item {{ Route::is('admin.appointment*')? 'active' : '' }}">
                <a class="nav-link collapsed" href="{{ route('admin.appointment.index') }}" data-toggle="collapse" data-target="#collapseTwo"
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.appointment.index') }}">Pending</a>
                        <a class="collapse-item" href="{{ route('admin.appointment.is_approve',1) }}">Approve</a>
                        <a class="collapse-item" href="{{ route('admin.appointment.is_going',5) }}">On Going</a>
                        <a class="collapse-item" href="{{ route('admin.appointment.is_done',3) }}">Done</a>
                        <a class="collapse-item" href="{{ route('admin.appointment.is_decline',2) }}">Declined</a>
                        <a class="collapse-item" href="{{ route('admin.appointment.is_expired',4) }}">Expired</a>
                    </div>
                </div>
            </li>

            <li class="nav-item {{ Route::is('admin.assignroom*')? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.assignroom.index') }}">
               ...
               <li class="nav-item {{ Route::is('admin.room*')? 'active' : '' }}">
            ...
            <li class="nav-item {{ Route::is('admin.account*')? 'active' : '' }}">
