...
<div>
    <div style="display: flex; justify-content:space-between;">
        <a href="{{ route('admin.service.index') }}" class="btn btn-info my-2">Back</a>
        <a href="" class="btn btn-danger my-2" data-backdrop="static" tabindex="-1" role="dialog" data-toggle="modal" data-target="#deleteModal-{{ $service->id }}"><i clas
            class="fa fa-trash"></i></a>
    </div>
    <form action="{{ route('admin.service.destroy',$service->id) }}" method="POST">
        <div class="modal fade" id="deleteModal-{{ $service->id }}" tabindex="-1" role="dialog" aria-labelledby="acceptModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                <p style="font-size: 1.3rem; color:red;">Are you sure you want to Delete this Service?</p>
           ...
           <div class="row">
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $service->cost }}" name="cost" class="form-control">
                        @error('cost')
                        <span style="color:red;">{{ $message }}</span>
                    @enderror
                    </div>
